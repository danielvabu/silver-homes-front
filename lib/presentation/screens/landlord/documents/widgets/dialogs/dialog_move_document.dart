...
class AlertDialogMoveDocument extends StatefulWidget {
  final String title;
  ...
  final String documentNewFatherUUID;

  AlertDialogMoveDocument({
    ...
    required String documentNewFatherUUID,
  })  : title = title,
        ...
        documentNewFatherUUID = documentNewFatherUUID;

  @override
  _AlertDialogMoveDocumentState createState() =>
      _AlertDialogMoveDocumentState();
}
...
class _AlertDialogMoveDocumentState extends State<AlertDialogMoveDocument> {
  ...
  _moveDocument(Bloc bloc) async {
    ...
    print("isMoveDocument $isMoveDocument");
  }
