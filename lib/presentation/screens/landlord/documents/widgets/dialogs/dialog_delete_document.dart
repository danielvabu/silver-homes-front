...
class AlertDialogDeleteDocument extends StatefulWidget {
  final String title;
  ...
  @override
  _AlertDialogDeleteDocumentState createState() =>
      _AlertDialogDeleteDocumentState();
}

class _AlertDialogDeleteDocumentState extends State<AlertDialogDeleteDocument> {
  final _nameFolderController = new TextEditingController();
  DocumentsService documentsService = new DocumentsService();

  _deleteDocument(Bloc bloc) async {
    bool? isDeleteDocument = await documentsService.restoreDocument(
        context, widget.documentUUID, widget.documentFatherUUID);
    print("isDeleteDocument $isDeleteDocument");
  }
