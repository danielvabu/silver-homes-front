...
class RoleHeader extends StatefulWidget {
  ...
  @override
  _RoleHeaderState createState() => _RoleHeaderState();
}
...
class _RoleHeaderState extends State<RoleHeader> {
  ...
  List<Widget> _headerRow() {
    var result = <Widget>[];
    result.add(_headerPropertyName("Role Name"));
    result.add(_headerUnit("Properties"));
    result.add(_headerCity("Tenants"));
    result.add(_headerCountry("Maintenance"));
    result.add(_headerPropertyType("Payments"));
    result.add(_headerVacancy("Accounting"));
    result.add(_headerVacancy("Documents"));
    result.add(_headerVacancy("Task"));
    result.add(_headerVacancy("Team Management"));
