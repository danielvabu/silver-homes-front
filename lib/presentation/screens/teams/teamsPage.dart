...
import 'package:silverhome/presentation/screens/teams/roleSelectionPage.dart';
...
class _TeamMemberState extends State<TeamMember> {
  ...
  Widget _togglebutton() {
    return Container(
      ...
      child: ToggleSwitch(
        ...
        labels: ["Assigned Properties", "Unassigned Properties"],
  ...
  showAlertDialogEditAssigmentRol(BuildContext context) {
    showDialog(
        context: context,
  ...
  showAlertDialogEditRol(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => new AlertDialog(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10.0))),
  ...
  showAlertDialogCreateRol(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => new AlertDialog(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10.0))),
  ...
  Widget _addNewLead() {
    return InkWell(
      ...
      child: CustomeWidget.AddNewRole(),
    );
  }
