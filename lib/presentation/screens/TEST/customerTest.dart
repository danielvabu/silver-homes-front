...
import 'package:silverhome/presentation/screens/customer/customer_property_details_page.dart';
import 'package:silverhome/presentation/screens/customer/customer_property_list_page.dart';
          ...
          if (isNoDatafound) {
            ...
            return ListView(
              children: [
                ...
                // CustomerPropertyDetailsPage(LID: Prefs.getString(PrefsName.Customer_OwnerID)),
      ...
      case 0:
        {
          return CustomerPropertyListPage(
            id: widget.idProperties.toString(),
          );
        }
      case 1:
        {
          // getFeaturePropertyDetails(cusPortalState., cusProlistState);
