...
//"https://www.ren-hogar.com/#/
  ...
  //static var API_Server = 'http://staging.silverhomes.ai';

  static var API_Server = isPROD_API ? "https://api.silverhomes.ai" : "https://qjif09kr99.execute-api.us-east-1.amazonaws.com/dev";
...
//      : "https://25k75q7gy2.execute-api.us-east-1.amazonaws.com";
  ...
  static var DocURL = API_Server + "/appdata/" + API_CODE + "/Attachments/Files/";
...
//TEAM MEMBERS
  static var Teams_members_Api = base_url + "/team/team-members";
  ...
  static var Sample_property_value_file = Email_URL + "data_entry_instructions.xlsx";

  static var PrivacyPolicy_and_TermsConditions = "https://www.silverhomes.ai/legal";

  static var verification_document_url = "https://www.consumer.equifax.ca/personal/products/credit-score-report/";
  ...
  static var DSQ_PropertyOnBoardingList = "A31C1BFE-C78D-425F-B9F6-F7D2A6B70BE7";
  ...
  static var DSQ_EventTypesOnBoardingList = "A31C1BFE-C78D-425F-B9F5-F7D2A6B60BE8";

  static var DSQ_EventTypesOnBoardingListTemp = "A31C1BFE-C78D-425F-B9F5-F7D2A6B60999";

  static var DSQ_EventTypesOnBoardingListTempver = "A31C1BFE-C78D-425F-B9F5-F7D2A6B60992";
  ...
  static var DSQ_APPLICATIONLIST_OWNERWISE = "CB8345B3-BA21-4FB7-8B38-BBF7EF074AA7";
  ...
  static var DSQ_APPLICANT_AdditionalOccupant = "64cfba80-7ccb-4ea0-aa07-d5b8ef0e8919";
  static var DSQ_APPLICANT_AdditionalReference = "91bb808a-01a7-44c8-b637-e117231ebf74";
  static var DSQ_APPLICANT_CurrentTenancy = "85424946-cf76-4849-a4c6-11cba825e5e3";
  ...
  static var DSQ_VIEW_VARIFICATION_DOCUMENTData = "B9027858-8D51-485F-BFDB-00ED6D5207A2";
  static var DSQ_VIEW_VARIFICATION_DOCUMENTLIST = "c9034517-1c57-4910-b93c-b0822974cb48";
  static var DSQ_APPLICANT_REFERENCE_CHECK_LIST = "192C8D29-A42B-45AA-B77D-4D4DFB3F1D8A";
  static var DSQ_REFERENCE_LIST_APPLICANT_WISE = "025566ED-F18F-47A0-907E-8C2AB625497B";
  ...
  static var Reference_Request_workflow = "D1397E39-98B0-4C24-BF25-9B9FFC9A22AC";
  ...
  static var WorkFlow_DuplicateEventype = "1DF5CC24-A44B-45DE-B9E4-289D65EAC222";
  static var WorkFlow_DuplicateEventypeTemplate = "1DF5CC24-A44B-45DE-B9E4-289D65EAC777";
  static var WorkFlow_CreateTemplateEventype = "1DF5CC24-A44B-45DE-B9E4-289D65EAC333";
  ...
  static var WorkFlow_ResetPassWordMain = "261197C1-A298-4C0F-9954-6373630EC312";
...
=======
  static var WorkFlow_Property_Archive_Restore = "FE623FE8-9538-41C1-A505-AD22EF773A8D";
  static var WorkFlow_All_Archive_Property = "A92FF41C-3874-4F6D-AA1F-433B9054B509";
  static var WorkFlow_ReferenceRequestReceivedDate = "DED13ACC-FE21-4090-AB2C-08A8ACB28620";
  static var WorkFlow_RestoreAllArchive = "ECC4B79A-77D6-431A-83F8-F58BE84FA562";
>>>>>>> cd2e10c4e9bd9407f5b3a083142af2361d50c83c
  static var WorkFlow_ActiveTenant = "34F4BE34-7F77-4C58-B600-1EF90B0292AD";
  static var WorkFlow_Notifi_Application = "D0798C7C-C674-452E-9CCA-578F710B7E87";
  ...
  static var WorkFlow_Terminate_Tenancy = "709403DF-8279-455A-BC8D-1188D0DA1FE4";
  ...
  static var Admin_Landlord_propertyList = "A31C1BFE-C78D-425F-B9F6-F7D2A6B70BE7";
  static var Admin_Landlord_propertyList_New = "CC387F7A-B084-482A-9302-95669E77ADF8";
  static var Admin_Landlord_property_details = "4602BD62-35B7-42FD-81E4-D14AA7D13ED5";
  static var Admin_Landlord_LeadsList = "EBE4AF34-DD14-48AE-BE48-506EBC162BA5";
  static var Admin_Landlord_Leads_details = "0FE8C355-75AA-453E-881D-E3D91D3B4D11";
  static var workflow_Admin_Landlord_Property_Upload = "92A8329A-F944-4167-A12D-5250F14EDDFC";
  static var workflow_Admin_Customer_URL = "44B63695-7DEE-4720-816C-395371DDF113";
  ...
  static var DSQ_TenantEmail_already_Property = "1879AF78-107B-4DC6-813A-47A6B5C22E6C";

  /*============================================================================*/
  /*============================= Maintenace Module ============================*/
  /*============================================================================*/
  static var DSQ_landlord_Maintenance_Count = "e337b8ca-53f2-47ef-93ab-bde4129f3772";
  static var DSQ_Property_Maintenance_list = "77a3bf68-b6de-451c-83b8-06652e433d28";
  //static var DSQ_landlord_MaintenanceList = "08EC96E2-F319-463C-A0FB-9E44202CCC44";
  static var DSQ_landlord_MaintenanceList = "0d6fa4ab-3b15-496d-b181-3a860a4181f8";
  static var DSQ_landlord_Maintenance_Details = "3558F43C-6981-4843-8229-7552048F58C8";
  static var DSQ_landlord_MaintenanceVendor_Details = "d114ea9b-61fc-443f-a200-72be8718c992";
  static var DSQ_landlord_PropertyMaintenanceImages = "fb4d7ee9-9cbb-48a6-b738-97bdc234c4be";
  static var DSQ_LogActivity_list = "78DCFF48-E132-4F9F-87BE-81788F930614";
  static var DSQ_Applicant_Propertywise = "2b72bb56-5c52-4d1f-b3b7-3b5007039a2c";
  static var workflow_landlord_Maintenance_Duplicate = "A9449386-B324-43A0-8315-8AF80B4AD56E";
  ...
  static var workflow_landlord_Vendor_Duplicate = "480d26a5-e639-4223-b3f2-09c83c51b8fe";

  /*============================================================================*/
  /*=============================  Tenant Profile  ===============================*/
  /*============================================================================*/
  static var WorkFlow_tenant_forgotpass = "4BF75FD9-98E2-4F0D-968C-D381DDDDC6BF";
  static var workflow_tenant_register_old = "E27A87B1-0E21-41D4-916B-06A3200134A3";
  ...
  static var DSQ_Application_by_Applicant = "02d871a8-5ce3-4579-9f6c-ba0ec83c53db";
  /*============================================================================*/
  /*=============================  Documents  ===============================*/
  /*============================================================================*/
