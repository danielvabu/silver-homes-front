...
class PropertyHeader extends StatefulWidget {
  ...
  @override
  _PropertyHeaderState createState() => _PropertyHeaderState();
}
...
class _PropertyHeaderState extends State<PropertyHeader> {
  ...
  List<Widget> _headerRow() {
    var result = <Widget>[];
    result.add(_headerPropertyName(GlobleString.PH_Property_Name));
    ...
    result.add(_headerPropertyType(GlobleString.PH_Property_Type));
