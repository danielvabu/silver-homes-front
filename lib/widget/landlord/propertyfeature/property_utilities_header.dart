...
class PropertyUtilitiesHeader extends StatefulWidget {
  @override
  _PropertyUtilitiesHeaderState createState() =>
      _PropertyUtilitiesHeaderState();
}

class _PropertyUtilitiesHeaderState extends State<PropertyUtilitiesHeader> {
  ...
  List<Widget> _headerRow() {
    var result = <Widget>[];
    result.add(_headerAmenities(GlobleString.PS3_Property_Features_Utilities));
