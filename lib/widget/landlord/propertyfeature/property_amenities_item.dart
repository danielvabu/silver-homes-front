...
class PropertyAmenitiesItem extends StatefulWidget {
  ...
  @override
  _PropertyAmenitiesItemState createState() => _PropertyAmenitiesItemState();
}

class _PropertyAmenitiesItemState extends State<PropertyAmenitiesItem> {
