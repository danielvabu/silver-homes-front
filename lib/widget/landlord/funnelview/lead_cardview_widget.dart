...
class LeadCardViewWidget extends StatefulWidget {
  ...
  final CallbackInvite _callbackInvite1;
  ...
  LeadCardViewWidget({
    ...
    required CallbackInvite callbackInvite,
    required CallbackLeadInfo callbackLeadInfo,
    required CallbackEditLead callbackEditLead,
    required CallbackArchive callbackArchive,
    ...
    required int pos,
        ...
        this.pos = pos,
        this._callbackInvite1 = callbackInvite,
        this._callbackEditLead = callbackEditLead,
        this._callbackLeadInfo = callbackLeadInfo,
        this._callbackArchive = callbackArchive,
  ...
  @override
  _LeadCardViewWidgetState createState() => _LeadCardViewWidgetState();
}

class _LeadCardViewWidgetState extends State<LeadCardViewWidget> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    children: [
                      LeadPopupMenu(
                        onPressedInviteApply: () {
                          widget._callbackInvite1();
                        },
                        onPressedEditLead: () {
                          widget._callbackEditLead();
                        },
                        onPressedArchive: () {
                          widget._callbackArchive();
                        },
                        onPressedLeadInfo: () {
                          widget._callbackLeadInfo();
                        },
                        isListView: false,
                      ),
                      Container(
