...
class ReferenceCheckedCardViewWidget extends StatefulWidget {
  ...
  ReferenceCheckedCardViewWidget({
  ...
  @override
  _ReferenceCheckedCardViewWidgetState createState() =>
      _ReferenceCheckedCardViewWidgetState();
}

class _ReferenceCheckedCardViewWidgetState
    extends State<ReferenceCheckedCardViewWidget> {
  @override
  void initState() {
    super.initState();
  }
