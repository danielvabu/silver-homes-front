...
class ActiveTenantCardViewWidget extends StatefulWidget {
  ...
  @override
  _ActiveTenantCardViewWidgetState createState() =>
      _ActiveTenantCardViewWidgetState();
}

class _ActiveTenantCardViewWidgetState
    extends State<ActiveTenantCardViewWidget> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    children: [
                      ActiveTenantPopupMenu(
                        ...
                        onPressedACEditTenet: () {
                          widget._callbackACEditTenet();
                        },
                        onPressedACArchive: () {
                          widget._callbackACArchive();
                        },
                        onPressedInviteTenant: () {
                          widget._callbackInviteTenant();
                        },
                      ),
                      Container(
                        height: 20,
