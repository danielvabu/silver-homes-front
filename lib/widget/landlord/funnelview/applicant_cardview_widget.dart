...
class ApplicantCardViewWidget extends StatefulWidget {
  ...
  @override
  _ApplicantCardViewWidgetState createState() =>
      _ApplicantCardViewWidgetState();
}

class _ApplicantCardViewWidgetState extends State<ApplicantCardViewWidget> {
  @override
  void initState() {
    super.initState();
  }
