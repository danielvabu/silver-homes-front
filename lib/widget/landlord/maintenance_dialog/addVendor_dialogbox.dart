...
class AddVendorDialogBox extends StatefulWidget {
  ...
  @override
  _AddVendorDialogBoxState createState() => _AddVendorDialogBoxState();
}

class _AddVendorDialogBoxState extends State<AddVendorDialogBox> {
  ...
  void initState() {
    apimanager();
    AddVendorDialogBox.changeData = false;
    super.initState();
  }
  ...
  _changeData() {
    if (!change) {
      change = true;
      AddVendorDialogBox.changeData = true;
    }
  }
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                if (!AddVendorDialogBox.changeData) {
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Text(
                                          addVendorState!.vid != 0
                                              ? GlobleString.LMV_Edit_Vendor
                                              : GlobleString.LMV_Add_New_Vendor,
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style:
                                        MyStyles.Medium(17, myColor.text_color),
                                    textAlign: TextAlign.start,
                                  ),
                                ),
                                SizedBox(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: <Widget>[
                                                        CountryCodePicker(
                                                          onChanged: (value) {
                                                            _store.dispatch(
                                                                UpdateADV_cdialcode(value
                                                                    .dialCode
                                                                    .toString()));
                                                            _store.dispatch(
                                                                UpdateADV_ccountrycode(
                                                                    value.code
                                                                        .toString()));
                                                            _changeData();
                                                          },
                                                  ...
                                                  Container(
                                                    ...
                                                    child: DropdownSearch<
                                                      ...
                                                      onChanged: (value) {
                                                        _changeData();
                                                        _store.dispatch(
                                                            UpdateADV_selectedCountry(
                                                                value));

                                                        _store.dispatch(
                                                            UpdateADV_statedatalist(
                                                                []));
                                                        _store.dispatch(
                                                            UpdateADV_citydatalist(
                                                                []));
                                                        _store.dispatch(
                                                            UpdateADV_selectedCity(
                                                                null));
                                                        _store.dispatch(
                                                            UpdateADV_selectedState(
                                                                null));
  ...
  void checkValidation(BuildContext context, AddVendorState addVendorState) {
    ...
    if (addVendorState.companyname == null ||
        addVendorState.companyname.isEmpty) {
      ToastUtils.showCustomToast(
          context, GlobleString.ADV_error_companyname, false);
    } else if (addVendorState.selectCategory == null) {
      ToastUtils.showCustomToast(
          context, GlobleString.ADV_error_category, false);
      ...
      ToastUtils.showCustomToast(
          context, GlobleString.ADV_error_phone_valid, false);
    } else if (addVendorState.selectedCountry == null) {
      ToastUtils.showCustomToast(
          context, GlobleString.ADV_error_country, false);
  ...
  void editVendor(AddVendorState addVendorState) {
    ...
    vendorData.Category =
        addVendorState.selectCategory!.EnumDetailID.toString();
    ...
    ApiManager().EditVendor(context, propertyUpdate, vendorData,
        (error, respoce) {
      if (error) {
        loader.remove();
        ToastUtils.showCustomToast(
            context, GlobleString.ADV_update_successfully, true);
        widget._callbackSave();
      } else {
        loader.remove();
        ToastUtils.showCustomToast(
  ...
  void addVendor(AddVendorState addVendorState) {
    ...
    ApiManager().InsetNewVendor(context, vendorData, (error, respoce) {
      if (error) {
        loader.remove();
        ToastUtils.showCustomToast(
            context, GlobleString.ADV_insert_successfully, true);
        widget._callbackSave();
      } else {
        loader.remove();
        ToastUtils.showCustomToast(
