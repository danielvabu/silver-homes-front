...
class AddAssigneVendorItemWidget extends StatefulWidget {
  ...
  AddAssigneVendorItemWidget(
      ...
      : this.dmodel = dmodel1,
        this.pos = pos,
        this.addMaintenanceState = addMaintenanceState,
        this.count = count,
        this._callbackDelete = onPressedDelete;

  @override
  _AddAssigneVendorItemWidgetState createState() =>
      _AddAssigneVendorItemWidgetState();
}

class _AddAssigneVendorItemWidgetState
    extends State<AddAssigneVendorItemWidget> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownSearch<SystemEnumDetails>(
                      mode: Mode.MENU,
                      items: widget.addMaintenanceState.filterCategorylist,
                      ...
                      enabled: widget.addMaintenanceState.selectedCity !=
                                  null &&
                              widget.addMaintenanceState.selectedCity!.length >
                                  0
                          ? true
                          : false,
                      selectedItem: widget.dmodel.selectfilterCategory != null
                          ...
                          : null,
                      defultHeight:
                          widget.addMaintenanceState.filterCategorylist.length *
                                      35 >
                                  250
                              ? 250
                              : widget.addMaintenanceState.filterCategorylist
                                      .length *
                                  35,
                      ...
                      onChanged: (value) async {
                        List<VendorData> vendordatalist =
                            await Helper.filtervendor(
                                widget.addMaintenanceState.mainvendordatalist,
                                value!);
                        ...
                        /*  widget.addMaintenanceState.vendordatalist[widget.pos].selectfilterCategory = value;
                        widget.addMaintenanceState.vendordatalist[widget.pos].selectvendor = null;
                        widget.addMaintenanceState.vendordatalist[widget.pos].filtervendordatalist = vendordatalist;
