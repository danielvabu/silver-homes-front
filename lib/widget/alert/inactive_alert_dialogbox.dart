...
class InActiveAlertDialogBox extends StatefulWidget {
  final String title;
  ...
  @override
  _InActiveAlertDialogBoxState createState() => _InActiveAlertDialogBoxState();
}

class _InActiveAlertDialogBoxState extends State<InActiveAlertDialogBox> {
  @override
        ...
        child: Padding(
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(
                minWidth: 500, maxWidth: 500, minHeight: 250, maxHeight: 300),
            child: Container(
